...
public class APIIntegrationTests {
    ...
    static {
        RestAssured.port = 14260;
    }

    /**
     * curl http://localhost:14260 \
     -X POST \
     ...
     * curl http://localhost:14260 \
     -X POST \
     -H 'Content-Type: application/json' \
     -d '{"command": "addNeighbors", "uris": ["udp://8.8.8.8:14260", "udp://8.8.8.5:14260"]}'
     */
    @Test
    public void shouldTestAddNeighbors() {
        ...
        request.put("uris", new String [] {"udp://8.8.8.8:14260", "udp://8.8.8.5:14260"} );
        given().
                contentType("application/json").
                body(gson.toJson(request)).
                when().
     ...
     * curl http://localhost:14260 \
     -X POST \
     -H 'Content-Type: application/json' \
     -d '{"command": "removeNeighbors", "uris": ["udp://8.8.8.8:14260", "udp://8.8.8.5:14260"]}'
     */
    @Test
